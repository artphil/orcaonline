...
public class ProdutoRepositoryTest {
	...
	public void saveProdutoWithTooLongNameShouldThrowsConstraintViolationException() {
		...
		Throwable exception = assertThrows(ConstraintViolationException.class, () -> {
			...
			Produto pro = new Produto("Nome do ProdutoNome do ProdutoNome do ProdutoNome do ProdutoNome do ProdutoNome do Produto"+
					"Nome do ProdutoNome do ProdutoNome do ProdutoNome do ProdutoNome do Produto"+
					"Nome do ProdutoNome do ProdutoNome do ProdutoNome do ProdutoNome do Produto"+
					"Nome do ProdutoNome do ProdutoNome do ProdutoNome do ProdutoNome do Produto", "Descrição do Produto", ncm, gte);
			this.repositoryP.save(pro);
		});
	...
	public void saveProdutoWithTooLongDescriptionShouldThrowsConstraintViolationException() {
		...
		Throwable exception = assertThrows(ConstraintViolationException.class, () -> {
			...
			Produto pro = new Produto("Nome do Produto", "Descrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do Produto"+
					"Descrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do Produto"+
					"Descrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do Produto"+
					"Descrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do Produto"+
					"Descrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do Produto"+
					"Descrição do ProdutoDescrição do ProdutoDescrição do ProdutoDescrição do Produto", ncm, gte);
			this.repositoryP.save(pro);
		});
