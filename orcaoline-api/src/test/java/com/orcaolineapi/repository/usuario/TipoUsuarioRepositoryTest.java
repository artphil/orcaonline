...
public class TipoUsuarioRepositoryTest {
	...
	public void saveTipoUsuarioWithBlankDescriptionShouldThrowsConstraintViolationException() {
		...
		assertThat((exception.getMessage()).contains("interpolatedMessage='{0} não pode estar em branco(a).'") && (exception.getMessage()).contains("interpolatedMessage='{0} deve conter apenas letras.'") && (exception.getMessage()).contains("interpolatedMessage='{0} deve ter o tamanho entre 5 e 200.'"));
	}
	...
	public void saveTipoUsuarioWithTooLongNameShouldThrowsConstraintViolationException() {
		...
		Throwable exception = assertThrows(ConstraintViolationException.class, () -> {
			...
			TipoUsuario tip = new TipoUsuario("Nome do TipoUsuarioNome do TipoUsuarioNome do TipoUsuarioNome do TipoUsuarioNome do TipoUsuarioNome do TipoUsuario"+
					"Nome do TipoUsuarioNome do TipoUsuarioNome do TipoUsuarioNome do TipoUsuarioNome do TipoUsuario", "Descrição do TipoUsuario", permissoes);
			this.repositoryT.save(tip);
		});
	...
	public void saveTipoUsuarioWithTooLongDescriptionShouldThrowsConstraintViolationException() {
		...
		Throwable exception = assertThrows(ConstraintViolationException.class, () -> {
			...
			TipoUsuario tip = new TipoUsuario("Nome do TipoUsuario", "Descrição do TipoUsuarioDescrição do TipoUsuarioDescrição do TipoUsuarioDescrição do TipoUsuario"+
					...
					"Descrição do TipoUsuarioDescrição do TipoUsuarioDescrição do TipoUsuarioDescrição do TipoUsuarioDescrição do TipoUsuarioDescrição do TipoUsuario"+
					"Descrição do TipoUsuarioDescrição do TipoUsuarioDescrição do TipoUsuarioDescrição do TipoUsuario", permissoes);
			this.repositoryT.save(tip);
		});
